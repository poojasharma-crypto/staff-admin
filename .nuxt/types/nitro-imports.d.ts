...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/xampp/htdocs/staff-admin/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/xampp/htdocs/staff-admin/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { db } from 'C:/xampp/htdocs/staff-admin/server/utils/db';